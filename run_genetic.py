...
def test5():
    ...
    current_best = [[0, 2, 3.7985137504178668, 0, 0, 1, 4.270129330372036, 2, 0, 0, 3.287767043436472, 1, 0, 2, 0.24493811107253177, 0, 0, 1, 0.5154287684915483, 2, 0, 0, 5.036812068940583, 2],
...
def main():
    ...
    grad = False
    check = False
    reachable_points, constraint, d, base, origin, basis, shapes, limits, best = test5()

    if check:
        for b in best:
            display(b, reachable_points, constraint, base, origin, basis, shapes, limits, points = True, ani=True)
    ...
    display(best, reachable_points, constraint, base, origin, basis, shapes, limits, points = True, ani=True)
